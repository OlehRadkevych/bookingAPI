...
class TestUpdateBooking:
    def test_update_valid_booking(self, api_client, create_booking, booking: Booking):
...
class TestUpdateBookingNegative:
    @pytest.mark.parametrize(
        "firstname, lastname, case_id",
        TEST_MATRIX,
        ids=[c[2] for c in TEST_MATRIX]
    )
    def test_update_invalid_first_last_names(self, api_client, create_booking, booking: Booking, firstname, lastname,
                                             case_id):
        booking_id = create_booking
        payload = booking.booking_data()
    ...
    def test_update_invalid_booking_negative_total_price(self, api_client, create_booking, booking: Booking,
                                                         invalid_totalprice):
        booking_id = create_booking
        payload = booking.booking_data()
    ...
    def test_update_invalid_booking_wrong_dates(self, api_client, create_booking, booking: Booking, invalid_bookingdates):
        booking_id = create_booking
        payload = booking.booking_data()
    ...
    def test_update_invalid_booking(self, api_client, create_booking, booking: Booking):
        booking_id = create_booking
